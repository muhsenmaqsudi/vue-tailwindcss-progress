    ...
    <div class="flex-1 min-w-0 bg-white">
      ...
      <div class="flex-1 overflow-auto">
        <main class="p-3 h-full inline-flex">
          <!-- first column -->
          <div class="flex-shrink-0 p-3 w-4/12 bg-gray-100 rounded">
          ...
          <!-- end of first column -->
          <!-- 2nd column -->
          <div class="ml-3 flex-shrink-0 p-3 w-4/12 bg-gray-100 rounded">
            <h3 class="text-sm font-medium text-gray-700">Backlog</h3>
            <ul class="mt-2">
              <li class="">
                <a href="#" class="block p-5 bg-white rounded shadow">
...
export default {
  name: 'App',
  components: { sidebar: Sidebar, 'top-header': Header },
};
</script>
